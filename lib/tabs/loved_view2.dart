...
class LovedView2 extends StatefulWidget {
  final String uid;
  const LovedView2({
    super.key,
    required this.uid,
  ...
  @override
  State<LovedView2> createState() => _LovedView2State();
}

class _LovedView2State extends State<LovedView2> {
  int postCount = 0;
  ...
  Future<void> getPostCount() async {
    try {
      ...
      QuerySnapshot snapshot1 =
          await docsRef.where('like', arrayContains: widget.uid).get();
      setState(() {
  ...
  // Future<String?> generateThumbnail(String videoPost) async {
  //   try {
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              YourPost(postId: post['postId'], uid: widget.uid,),
                                        ),
                                      );
                                    },
                                    child: FadeInImage(
