                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Column(
                                                                  ...
                                                                  onTap: () async {
                                                                    bool? confirmDelete = await showDialog<bool?>(
                                                                      ...
                                                                      builder: (context) => AlertDialog(
                                                                        ...
                                                                        content: Text('Are you sure about deleting your post?'),
                                                                        actions: [
                                                                          TextButton(
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Row(
                                                                                                                  children: [
                                                                                                                    ...
                                                                                                                    currentUser.uid == userCurrent['uid'] ? SizedBox(
                                                                                                                      width: 20,
                                                                                                                    ) : Container(),
                                      ...
                                      OtherImageSection(postId: widget.postId, uid: currentUser.uid,),
                                      OtherVideoSection(postId: widget.postId, uid: currentUser.uid,),
                                      OtherLovedSection(postId: widget.postId, uid: currentUser.uid,),
                                    ]),
                                  ),
                                ],
                              );
